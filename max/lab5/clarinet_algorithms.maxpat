...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 479.0, 410.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 378.0, 410.0, 71.0, 22.0 ],
					"text" : "algorithm_7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 280.0, 410.0, 71.0, 22.0 ],
					"text" : "algorithm_8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 72.0, 110.0, 22.0 ],
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Library/21M.379",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
